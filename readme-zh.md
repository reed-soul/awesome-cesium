...
**官方文档** — 教程与 API 参考：<https://cesium.com/learn/>

**Sandcastle** — 交互式代码示例（现已支持 [AI 语义搜索](https://cesium.com/blog/2026/03/19/ai-driven-semantic-search-sandcastle/)）：<https://sandcastle.cesium.com/>

**框架**：Vue → [vue-cesium](https://github.com/zouyaoji/vue-cesium) 🌟 | React → [resium](https://github.com/reearth/resium) 🌟
...
- [CesiumJS 官方教程](https://cesium.com/learn/) - 面向初学者的循序渐进教程和学习资源。
...
构建和打包指南请参见 [Cesium 官方文档](https://cesium.com/learn/cesiumjs/)。
...
- 构建和包优化请参见 [Cesium 官方文档](https://cesium.com/learn/cesiumjs/)。
